...
function validators() {
	...
	this.addValidator('dependencies', function(value, type, schema, properties) {
		if (type === 'object') {
	...
	this.addValidator('allOf', function(schema, value, parent, property) {
		var __all_idx = schema.__allOf.length;
		while (__all_idx--) {
			schema.__allOf[__all_idx].__validate(value, parent, property, this.errors);
		}
	});
