...
function validators() {
	...
	this.addValidator('minimum', function(value, type, schema, dataPath) {
	...
	this.addValidator('maximum', function(value, type, schema, dataPath) {
		if (type === 'integer' || type === 'number') {
			var __max;
	...
	this.addValidator('multipleOf', function(value, type, schema, CLOSE_ENOUGH_LOW, CLOSE_ENOUGH_HIGH, dataPath) {
		if (type === 'integer' || type === 'number') {
	...
	this.addValidator('uniqueItems', function(type, schema, value, dataPath) {
	...
	this.addValidator('$ref', function(schema, value, parent, property, dataPath, path) {
		var __ref_s;
		...
		if (__ref_s) {
			__ref_s.__validate(value, parent, property, path, this.errors);
		} else {
			this.addError({
	...
	this.addValidator('allOf', function(schema, value, parent, property, path) {
		var __all_idx = schema.__allOf.length;

		while (__all_idx--) {
			schema.__allOf[__all_idx].__validate(value, parent, property, path, this.errors);
		}
	});

	this.addValidator('anyOf', function(schema, value, parent, property, dataPath) {
	...
	this.addValidator('oneOf', function(schema, value, parent, property, type, dataPath) {
	...
	this.addValidator('not', function(schema, value, dataPath) {
