...
function Interface() {
	...
	this.addType = env.addType.bind(env);
	this.addFormat = env.addFormat.bind(env);
	this.addValidator = env.addValidator.bind(env);
	this.addVariable = env.addVariable.bind(env);
